...
class ReplayBuffer(Dataset):
    ...
    def sample_cpc(self):
        ...
        return obses, actions, rewards, next_obses, not_dones, cpc_kwargs, indices, weights
...
class CurlSacAgent(object):
    ...
    def update_critic(self, obs, action, reward, next_obs, not_done, step, weights):
    ...
    def update(self, replay_buffer, step):
        if self.encoder_type == 'pixel':
            obs, action, reward, next_obs, not_done, cpc_kwargs, idx, weights = replay_buffer.sample_cpc()
        else:
        ...
        prios = self.update_critic(obs, action, reward, next_obs, not_done, step, weights)
